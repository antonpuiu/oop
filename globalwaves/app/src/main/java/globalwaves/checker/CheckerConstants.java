...
public final class CheckerConstants {
    ...
    public static final String BIN_PATH = "bin/main/";
    public static final String TESTS_PATH = BIN_PATH + "input/";
    public static final String OUT_PATH = BIN_PATH + "result/out_";
    public static final String REF_PATH = BIN_PATH + "ref/ref_";
    public static final String RESULT_PATH = BIN_PATH + "result";
